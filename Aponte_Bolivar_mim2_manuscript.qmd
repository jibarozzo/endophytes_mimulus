...
phyloseq_ntaxa_by_tax(
  ...
  as.data.frame() |>
  mutate(sum = sum(N.OTU), Phylum = str_remove(Phylum, "^.*?(_|-).")) |>
  group_by(Species, Phylum) |>
  summarise(Occurrence = n()) |>
  knitr::kable(
    caption = "Table S2. Prevalence of phyla in samples per species."
  )
```
...
load("data/clean_data/statistics/anova_m5hell_margin.rds")

anova_table3 <- tidy(anova_m5hell_margin) |>
  as.data.frame() |>
