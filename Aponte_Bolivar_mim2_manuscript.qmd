...
### *Species differed in leaf functional traits*
...
### **Q1: Interspecific trait differences at similar elevations**  
...
### **Q2: Intraspecific trait shifts across elevation**  
...
### **FEF community patterns across elevation and geography**  

#### **Higher prevalence of Basidiomycetes in FEF community**
...
#### ***Q3: FEF diversity-composition relationships with elevation and traits*** 

We observed systematic shifts in FEF diversity, composition, and spatial structuring across elevations and host species, with leaf functional traits emerging as key predictors of community variation (Q3–Q4).

##### **Diversity declines with elevation**
...
##### **Trait-driven β-diversity patterns**  
...
### ***Q4: FEF community-distance relationships***
 Finally, geographic distance correlated significantly with FEF compositional turnover in *M. laciniatus* (*r* = 0.27, *p* = .01) and *M. nasutus* (*r* = 0.29, *p* < .01, [Fig. @fig-figure7]). No spatial signal was detected for *M. guttatus* (*r* = -0.004, *p* = .48). 

 TO-DO:
 
- TALK ABOUT THE DIRECTION
- NEED TO ADD TO THIS PARAGRAPHz
- Add Table 1
