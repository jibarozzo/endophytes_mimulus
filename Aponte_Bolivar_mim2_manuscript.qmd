...
r1gg <- r1gg +
  ...
  theme(legend.title = element_text(face = "bold"),
         ...
         axis.text.x = element_blank())
r1gg
ggsave(filename = file.path(path, "figures/figure2.png"), plot = r1gg, dpi=300, units=c("mm"), width=300, height=300)
...
hill_numbers
ggsave(filename = file.path(path, "figures/figure4.jpg"), plot = hill_numbers, dpi=300, units=c("mm"), width=275, height=300)
```
