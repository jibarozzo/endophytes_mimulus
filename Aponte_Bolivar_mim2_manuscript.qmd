...
mantel_test + geom_text(aes( x = 2000, y = 0.5, size = 4, label = paste("p = ", signif(abund_geo$signif, digits = 3), sep = "")))
...
llave <- "AIzaSyAswWq3mkTVX2oCP1ObVl-Wz9jMcFrJiLg"
register_google(key = llave, write = TRUE)
...
map <- ggmap(mappops, extent = "panel") +
  geom_point(
    data = map_latlong,
    aes(x
  ...
  layer_spatial(sf::st_bbox(map_latlong)) +
