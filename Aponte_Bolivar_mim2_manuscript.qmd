...
#Save the plot
ggsave(file.path(path, "figures/figure3.png"), plot = p_final_model, dpi=300, units=c("mm"), width=300, height=150)
```
...
mantel_species
ggsave(file.path(path, "figures/figure5.png") , plot = mantel_species, dpi=300, units=c("mm"), width=300, height=250)
```
