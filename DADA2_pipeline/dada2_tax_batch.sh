...
#SBATCH --error /lustre/project/svanbael/bolivar/Mimulus_sequences/MIM2_8450_tax.error          
#SBATCH --output /lustre/project/svanbael/bolivar/Mimulus_sequences/MIM2_8450_tax.output  
