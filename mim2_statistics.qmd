...
newdir <- "/home/baponte/Boxx/Dissertation/Mimulus/Data/CH2/bioinformatics"
```

#Leaf Traits
##Cleaning and Shaping
```{r, Mim2 Leaf traits, tidy=TRUE}
...
str(plant_traits)
#saveRDS(plant_traits, file.path(newdir, "statistics/plant_traits.rds"))
plant_traits <- readRDS(file.path(newdir, "statistics/plant_traits.rds"))
