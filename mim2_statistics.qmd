...
```
The B4AIC model has a lower AIC score. We seem to have hit a good model. The fixed terms are `mean_bray ~ logACI + logLPS + logLMA`. Let's take that an model random effects taking into account variance structure. 
