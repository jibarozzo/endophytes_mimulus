...
This is an interesting analysis. A PCA of the fungal communities is not that different from the dbRDA, qualitatively. But we appreciate the ASVs driving the patterns. We observed that the most abundant and prevalent ASV have the longest/strongest vectors. 
