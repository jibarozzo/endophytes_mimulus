...
m1 <- glm(mean_bray ~ Elevation_m + Species + Site, data = plant_traits_MB, family = gaussian) # Gaussian/Normal distribution
plot(m1)
anova(m1)
...
M1 <- lm(mean_bray ~ Elevation_m + Species + Site, data = plant_traits_MB, na.action = na.exclude)
anova(M1)
plot(M1)
AIC(M1) # -14900.34
