...
m2 <- dbrda(asv_avgdist ~ logACI + logLT + logLPS + logLMA + logLBI + Elevation_m + Site + Species, method = "bray", data = nmds_traits, na.action = na.omit)
...
m3 <- dbrda(asv_avgdist ~ logACI + logLT + logLPS + logLMA + Elevation_m + Site + Species, method = "bray", data = nmds_traits, na.action = na.omit)
# Anovas
anova(m3, by = "margin") # test for sign. environ. variables

# Remove logLMA p-value = 0.694 
m4 <- dbrda(asv_avgdist ~ logACI + logLT + logLPS + Elevation_m + Site + Species, method = "bray", data = nmds_traits, na.action = na.omit)
# Anovas
anova(m4, by = "margin") # test for sign. environ. variables

#Remove logLT p-value = 0.215
m5 <- dbrda(asv_avgdist ~ logACI + logLPS + Elevation_m + Site + Species, method = "bray", data = nmds_traits, na.action = na.omit)
# Anovas
