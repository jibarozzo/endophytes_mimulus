...
# Anovas
set.seed(123)
anova.cca(m4_hell, by = "margin", permutations = 999, parallel = 8) # test for sign. environ. variables
permustats(anova(cca1))
```
...
set.seed(123)
# By Species
beta <- betadisper(vegdist(dbrda_hell_matrix, method = "bray"), # This is a matrix of Hellinger transformed data rarefied 
