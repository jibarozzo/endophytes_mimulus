...
# Taking the mirl object from Method B and converting it to a phyloseq object
...
TAXA <- TAXA|>
  ...
  filter(colnames(10:166) %in% final_names)
select(-c(1))|>
...
# rarefied Abundance
micro_rarefied_ps <- phyloseq2meco(rrfps) # First convert phyloseq to meco
